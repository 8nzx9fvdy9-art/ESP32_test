#!/usr/bin/env python3
"""
Server WebSocket intermedio per comunicazione ESP32 <-> MacBook
Questo server deve essere eseguito su un server con IP pubblico
(es. Heroku, Railway, DigitalOcean, AWS, etc.)
"""
